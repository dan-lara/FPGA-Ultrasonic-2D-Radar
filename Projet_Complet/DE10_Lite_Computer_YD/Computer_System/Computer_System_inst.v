	Computer_System u0 (
		...
		.telemetre_out_dist_cm      (<connected-to-telemetre_out_dist_cm>),      //        telemetre_out.dist_cm
		...
		.neopixel_out_commande      (<connected-to-neopixel_out_commande>),      //         neopixel_out.commande
		.uart_out_commande_rx       (<connected-to-uart_out_commande_rx>),       //             uart_out.commande_rx
		.uart_out_commande_tx       (<connected-to-uart_out_commande_tx>)        //                     .commande_tx
	);
